 ...
 * NewJFrame.java
 *
 * Created on 07.07.2012, 11:30:47
 */
package client;
...
public class ConnectDialog extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField6.setText("No Error Messages... =)");
        ...
        jTextField4.setText("720");

        jLabel6.setText("Width");

        jTextField5.setText("1280");

        jRadioButton1.setText("Fullscreen");

        jRadioButton2.setSelected(true);
        jRadioButton2.setText("V-Sync");
        ...
        jTextField1.setText("UnknownPlayer");
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    String nick = this.jTextField1.getText();
    String ip = this.jTextField2.getText();
    String port = this.jTextField3.getText();
    String height = this.jTextField4.getText();
    String width = this.jTextField5.getText();
    String fullscreen = ""+this.jRadioButton1.isSelected();
    String vsync = ""+this.jRadioButton2.isSelected();
    // TODO switch main Method to this class ?
    MyClient.main(new String[] {ip, port, nick, height, width, fullscreen, vsync});
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                connectDialog.setTitle("Connect Dialog");
